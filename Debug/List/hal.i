#line 1 "C:\\Siddharth\\Personal\\Embedded C\\IAR_programs\\SpeedometerDesign\\hal.c"
/*************************************************************************/
/*  File name: 	hal.c
*
...
#line 20 "C:\\Siddharth\\Personal\\Embedded C\\IAR_programs\\SpeedometerDesign\\hal.h"
...
#line 22 "C:\\Siddharth\\Personal\\Embedded C\\IAR_programs\\SpeedometerDesign\\hal.h"
...
#line 18 "C:\\Siddharth\\Personal\\Embedded C\\IAR_programs\\SpeedometerDesign\\hal.c"
...
#line 19 "C:\\Siddharth\\Personal\\Embedded C\\IAR_programs\\SpeedometerDesign\\hal.c"
...
static p_fHallSensorCallback_t additional_CB; // Function pointer for additional callback function 
...
UINT16 getPPS()
{
  ...
  return (int)((float)pulse_count * 1000 / (3*1000));
}
...
{
  // Calculate RPM
  rpm = (int)((float)pulse_count * 60000 / (3*1000));
  return rpm;
}
...
void hal_process_HallSensor()
{
  ...
  __delay_cycles(3*1000000); // Interval cycles
...
/***********************************
  ...
  Name: hal_setCB_HallSensor
  Parameters: p_fHallSensorCallback_t p_fHallSensorCallback_t_in (Function pointer to additional CB)
  Return: void
...
void hal_setCB_HallSensor(p_fHallSensorCallback_t p_fHallSensorCallback_t_in)
{
  additional_CB = p_fHallSensorCallback_t_in;
}
